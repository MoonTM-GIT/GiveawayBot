package dev.moontm.giveawaybot.command;

import dev.moontm.giveawaybot.Bot;
import dev.moontm.giveawaybot.Constants;
import dev.moontm.giveawaybot.command.data.CommandDataLoader;
import dev.moontm.giveawaybot.command.data.context_commands.ContextCommandConfig;
import dev.moontm.giveawaybot.command.data.slash_commands.SlashCommandConfig;
import dev.moontm.giveawaybot.command.interfaces.IMessageContextCommand;
import dev.moontm.giveawaybot.command.interfaces.ISlashCommand;
import dev.moontm.giveawaybot.command.interfaces.IUserContextCommand;
...
public class InteractionHandler extends ListenerAdapter {
	...
	public void registerCommands(Guild guild) {
		var slashCommandConfigs = CommandDataLoader.loadSlashCommandConfig(
